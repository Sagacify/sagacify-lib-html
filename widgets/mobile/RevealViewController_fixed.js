define([
	...
	return declare('saga.RevealViewController_fixed', [ViewController], {
		...
		addFrontViewController: function(frontViewController){
			this.revealFrontViewController.push(frontViewController);
			frontViewController.domNode.style.display = "none";
			revealFrontViewController.on("revealButtonPressed", function(args){
        		if(me.isRevealed)
        			me.unrevealStart();
        		else {
